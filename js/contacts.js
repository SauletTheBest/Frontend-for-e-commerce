...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
        ...
        notification.innerText = "Your message has been sent successfully!";
        ...
        notification.style.boxShadow = "0 0 20px #ff00ff";
        notification.style.zIndex = "1000";
        notification.style.textShadow = "0 0 10px #ff00ff, 0 0 20px #ff00ff";
        notification.style.opacity = "0";
        notification.style.transition = "transform 1s ease, opacity 1s ease";
