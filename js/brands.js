...
document.addEventListener("DOMContentLoaded", function () {
    ...
    carItems.forEach((item) => {
        ...
        const description = strongElement.nextSibling;
        

        if (description && description.nodeType === Node.TEXT_NODE) {
            strongElement.after(document.createTextNode(" "));
            
            const descriptionSpan = document.createElement("span");
            descriptionSpan.textContent = description.textContent;
            descriptionSpan.style.display = "none";
            description.replaceWith(descriptionSpan);
